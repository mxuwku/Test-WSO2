...
<%
    String errorCode = URLDecoder.decode(request.getParameter("errorCode"),"UTF-8");
                        ...
                        <div class="padding-double">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group required">
                                ...
                                <input type="text" name="First Name"
                                       ...
                                       <%=AuthenticationEndpointUtil.i18n(resourceBundle, "required")%>
                                       <%}%>>
                            </div>
                            <%}%>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group required">
                                <label class="control-label">
                                    <%=AuthenticationEndpointUtil.i18n(resourceBundle, "username")%>
                                </label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group required">
                                <label class="control-label">
                                    <%=AuthenticationEndpointUtil.i18n(resourceBundle, "password")%>
                                </label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group required">
                                <label class="control-label">
                                    <%=AuthenticationEndpointUtil.i18n(resourceBundle, "confirm.password")%>
                                </label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group required">
                                <label <% if (isEmailRequired) {%> class="control-label" <%}%>>
                                    <%=AuthenticationEndpointUtil.i18n(resourceBundle, "email")%>
                                </label>
                            ...
                            %>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group required">
                                            <label <% if (userFieldDTO.getRequired()) {%> class="control-label" <%}%>>
                                                <%= Encode.forHtmlContent(userFieldDTO.getFieldName()) %>
                                            </label>
            ...
            (request.getParameter("sessionDataKey"))%>'/>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                                <span class="margin-top padding-top-double font-large">
                                    <%=AuthenticationEndpointUtil.i18n(resourceBundle, "already.have.an.account")%>
                                </span>
        ...
        $(document).ready(function () {
            ...
            $("#register").submit(function(e) {
                ...
                if(password != password2) {
                    error_msg.text(<%=AuthenticationEndpointUtil.i18n(resourceBundle, "passwords.mismatch.error.message")%>);
                    error_msg.show();
                ...
                $.ajax("registration.do", {
                    ...
                    success: function(data) {
                        if($.trim(data) === "User Exist") {
                            error_msg.text(<%=AuthenticationEndpointUtil.i18n(resourceBundle,
                            "user.already.exists")%>);
                            error_msg.show();
                            $("html, body").animate({ scrollTop: error_msg.offset().top }, 'slow');
                            e.preventDefault();
                    ...
                    error: function() {
                        error_msg.val(<%=AuthenticationEndpointUtil.i18n(resourceBundle,"unknown.error.occurred")%>);
                        error_msg.show();
                        e.preventDefault();
                    }
                });
