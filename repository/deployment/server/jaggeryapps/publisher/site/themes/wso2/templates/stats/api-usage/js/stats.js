        ...
        function (json) {
            ...
            if (!json.error) {
                ...
                inputData.map(function(data){
                    ...
                    $('#noData').html($('<div class="center-wrapper"><div class="col-sm-4"/><div class="col-sm-4 alert alert-info"><h4><i class="icon fw fw-info" title="' + i18n.t("No Stats") + '"></i>' + i18n.t("No Data Available") + '</h4></div></div>'));
                }
