            ...
            var data1 = {};
                if (json.usage && json.usage.length > 0) {
                  ...
                  for(var usage1 in json.usage ){
                    ...
                    $('#noData').html('');
                    $('#noData').append('<div class="center-wrapper"><div class="col-sm-4"/><div class="col-sm-4 alert alert-info"><h4><i class="icon fw fw-info" title="No Data Available"></i>'+i18n.t("No Data Available")+'</h4>'+ "<p> " + i18n.t('Generate some traffic to see statistics') + "</p>" +'</div></div>');
                    $('#chartContainer').hide();
