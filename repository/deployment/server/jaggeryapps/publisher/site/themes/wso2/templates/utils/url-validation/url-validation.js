                              ...
                              if (result.response.isConnectionError) {
                                if (result.response.response == null) {
                                    ...
                                    if (result.response.statusCode == null) { //When an exception is thrown from sendHttpHEADRequest method
                                        $(btn).parent().parent().after(' <span class="label label-danger url_validate_label"><i class="fw fw-cancel icon-white" title="invalid url"></i> ' + ' <span class ="url_validate_message"></span></span>');
